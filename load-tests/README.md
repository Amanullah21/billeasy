...
**Run**: `k6 run load-tests/k6-scripts/01-load-test.js`
...
**Run**: `k6 run load-tests/k6-scripts/02-stress-test.js`
...
**Run**: `k6 run load-tests/k6-scripts/03-spike-test.js`
...
**Run**: `k6 run load-tests/k6-scripts/04-soak-test.js`
...
**Run**: `k6 run load-tests/k6-scripts/05-scalability-test.js`
...
**Run**: `k6 run load-tests/k6-scripts/06-crud-operations-test.js`
...
**Run**: `k6 run load-tests/k6-scripts/07-error-handling-test.js`
...
**Run**: `k6 run load-tests/k6-scripts/08-concurrent-requests-test.js`
...
**Run**: `k6 run load-tests/k6-scripts/09-volume-test.js`
...
**Run**: `k6 run load-tests/k6-scripts/10-performance-benchmark-test.js`
...
**Run**: `k6 run load-tests/k6-scripts/api-load-test.js`
